...
window.onload = function () {
  document.getElementById('myName').textContent = currentUser.name || currentUser.username;
  document.getElementById('myDept').textContent = currentUser.department || '';
  var av = document.getElementById('myAvatar');
  av.textContent = initials(currentUser.name || currentUser.username);
  av.style.background = getColor(currentUser.username);
...
function toggleSection(id) {
  var list = document.getElementById(id === 'channels' ? 'channelsList' : id === 'dms' ? 'dmsList' : 'adminList');
